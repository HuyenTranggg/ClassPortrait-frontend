...
function TeacherDashboardView() {
  ...
  const handleStartAttendance = (classId: string) => {
    // We can pass state to tell RosterView to start attendance immediately
    navigate(`/classes/${classId}`, { state: { autoStartAttendance: true } });
  };

  const handleOpenShare = (classId: string) => {
    // We can pass state to tell RosterView to open share modal immediately
    navigate(`/classes/${classId}`, { state: { autoOpenShare: true } });
  };
