          ...
          <div className="import-modal-card" role="dialog" aria-modal="true" onClick={(event) => event.stopPropagation()}>
            ...
            {state.step === 3 && (
              <StepThree
                ...
                onManualSemesterChange={actions.setManualSemesterColumn}
                onManualDepartmentChange={actions.setManualDepartmentColumn}
                onManualClassCodeChange={actions.setManualClassCodeColumn}
                onManualCourseCodeChange={actions.setManualCourseCodeColumn}
                onManualCourseNameChange={actions.setManualCourseNameColumn}
                onManualClassNameChange={actions.setManualClassNameColumn}
                onManualClassExamCodeChange={actions.setManualClassExamCodeColumn}
                onManualExamDateChange={actions.setManualExamDateColumn}
                onManualExamRoomChange={actions.setManualExamRoomColumn}
                onManualExamTimeChange={actions.setManualExamTimeColumn}
                onManualExamShiftChange={actions.setManualExamShiftColumn}
                onManualInstructorChange={actions.setManualInstructorColumn}
                onManualDobChange={actions.setManualDobColumn}
                onManualGenderChange={actions.setManualGenderColumn}
                onManualEmailChange={actions.setManualEmailColumn}
